...
type Repository struct {
	...
	OwnerAccountID *uint     `gorm:"column:owner_account_id;uniqueIndex:uq_idx_repositoris_owner_name,priority:1"                 json:"owner_account_id"` // 所有者削除でNULLになるためポインタ型
	Name           string    `gorm:"column:name;type:varchar(255);not null;uniqueIndex:uq_idx_repositories_owner_name,priority:2" json:"name"`
